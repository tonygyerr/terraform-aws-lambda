...
bucket = "echo-photo-test-bucket"
key = "thumbnails"
localstack_s3_path = "s3://echo-photo-test-bucket"
thumbnail_qualituy = "90"
opacity = "1.0"
thumbnail_normal_width = 150
thumbnail_normal_height = 150
...
if 'LOCALSTACK_S3_PATH' in os.environ:
  ...
  localstack_s3_path =localstack_s3_path
      service_name='s3',
...
def put_object_on_s3(bucket, key, height, width, dpi, awsrequestid, manuallyTriggered=False, destination=None):
  ...
  thumbnail_normal_height = thumbnail_normal_height 
  thumbnail_normal_width = thumbnail_normal_width
